...
| File | Purpose | Audience | Status |
|------|---------|----------|--------|
| [TECHNICAL_DECISIONS_LOG.md](documentation/decisions/TECHNICAL_DECISIONS_LOG.md) | 89 active architectural decisions (newest first) | Architect, Senior Devs | Current |
