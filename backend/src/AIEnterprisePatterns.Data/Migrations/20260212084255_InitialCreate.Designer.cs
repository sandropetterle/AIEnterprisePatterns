...
namespace AIEnterprisePatterns.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20260212084255_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIEnterprisePatterns.Core.Entities.Pattern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Author = "Bob Williams",
                            Category = "Architecture",
                            CreatedDate = new DateTime(2024, 1, 10, 8, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            UpdatedDate = new DateTime(2024, 1, 10, 8, 0, 0, 0, DateTimeKind.Utc),
                            VoteCount = 34
                        },
                        new
                        {
                            ...
                            Author = "Carol Davis",
                            Category = "Security",
                            CreatedDate = new DateTime(2024, 1, 12, 13, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            UpdatedDate = new DateTime(2024, 1, 16, 10, 20, 0, 0, DateTimeKind.Utc),
                            VoteCount = 29
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 20, 15, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            UpdatedDate = new DateTime(2024, 1, 20, 15, 0, 0, 0, DateTimeKind.Utc),
                            VoteCount = 23
                        });
                });

            modelBuilder.Entity("AIEnterprisePatterns.Core.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PatternTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000001"),
                        ...
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000002"),
                        ...
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000002"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000006")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000003"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000007")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000003"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000008")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000003"),
                        ...
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000004"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000a")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000004"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000b")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000004"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000c")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000005"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000d")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000005"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000e")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000005"),
                            TagsId = new Guid("a0000000-0000-0000-0000-00000000000f")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000006"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000010")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000006"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000011")
                        },
                        new
                        {
                            PatternsId = new Guid("b0000000-0000-0000-0000-000000000006"),
                            TagsId = new Guid("a0000000-0000-0000-0000-000000000012")
                        });
                });

            modelBuilder.Entity("PatternTag", b =>
                {
                    b.HasOne("AIEnterprisePatterns.Core.Entities.Pattern", null)
                        .WithMany()
                        .HasForeignKey("PatternsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AIEnterprisePatterns.Core.Entities.Tag", null)
                        .WithMany()
